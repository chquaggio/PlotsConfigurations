...
echo "nuisance edit drop DY top CMS_PUID_2018" >> ${combinedcardsDir}/mjj_em_me.txt
...
echo "nuisance edit drop DY top CMS_btag_hf" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_btag_hfstats1_2018" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_btag_hfstats2_2018" >> ${combinedcardsDir}/mjj_em_me.txt
...
echo "nuisance edit drop DY top CMS_btag_lfstats1_2018" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_btag_lfstats2_2018" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_eff_e_2018" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_eff_hwwtrigger_2018" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop DY top CMS_eff_m_2018" >> ${combinedcardsDir}/mjj_em_me.txt
...
#echo "nuisance edit drop VgS dy QCDscale_VV" >> ${combinedcardsDir}/mjj_em_me.txt
...
echo "nuisance edit drop top top CMS_btag_cferr1" >> ${combinedcardsDir}/mjj_em_me.txt
echo "nuisance edit drop top top CMS_btag_hf" >> ${combinedcardsDir}/mjj_em_me.txt
