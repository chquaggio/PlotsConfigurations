...
cuts['DY']  = { 
   'expr' : 'dycr',
   'categories' : { 
      '2j_ee_lowDetajj'   : 'multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && abs(mll-91.2)<15 && detajj < 5',
      '2j_ee_highDetajj'  : 'multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11) && abs(mll-91.2)<15 && detajj >= 5',
      '2j_mm_lowDetajj'   : 'multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && abs(mll-91.2)<15 && detajj < 5',
      '2j_mm_highDetajj'  : 'multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && abs(mll-91.2)<15 && detajj >= 5',
      }
}