...
combineCards.py   vbs_ee_lowZ=${workDir}/${datacardDir}/VBS_2j_ee_lowZ/mjj/datacard.txt \
                  ...
                  dy_ee_lowDjj=${workDir}/${datacardDir}/DY_2j_ee_lowDetajj/events/datacard.txt \
                  dy_ee_highDjj=${workDir}/${datacardDir}/DY_2j_ee_highDetajj/events/datacard.txt \
...
echo "nuisance edit drop VgS_L top_ee CMS_PUID_2018" >> ${combinedcardsDir}/mjj_ee.txt
