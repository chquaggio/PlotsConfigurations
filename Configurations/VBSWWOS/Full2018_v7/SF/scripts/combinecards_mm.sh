...
combineCards.py   vbs_mm_lowZ=${workDir}/${datacardDir}/VBS_2j_mm_lowZ/mjj/datacard.txt \
                  ...
                  dy_mm_lowDjj=${workDir}/${datacardDir}/DY_2j_mm_lowDetajj/events/datacard.txt \
                  dy_mm_highDjj=${workDir}/${datacardDir}/DY_2j_mm_highDetajj/events/datacard.txt \
...
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_cferr1" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_cferr2" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_hf" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_hfstats1_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_hfstats2_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_jes" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_lf" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_lfstats1_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_btag_lfstats2_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_eff_e_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_eff_hwwtrigger_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj CMS_eff_m_2018" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj PS_FSR" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop VgS_L dy_mm_lowDjj PS_ISR" >> ${combinedcardsDir}/mjj_mm.txt
#echo "nuisance edit drop VgS_L dy_mm_lowDjj QCDscale_VV" >> ${combinedcardsDir}/mjj_mm.txt

echo "nuisance edit drop Fake_m dy_mm_highDjj CMS_fake_e_2018 Up" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop Fake_m dy_mm_highDjj CMS_fake_m_2018 Up" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop Fake_m dy_mm_highDjj CMS_fake_stat_e_2018 Up" >> ${combinedcardsDir}/mjj_mm.txt
echo "nuisance edit drop Fake_m dy_mm_highDjj CMS_fake_stat_m_2018 Up" >> ${combinedcardsDir}/mjj_mm.txt
